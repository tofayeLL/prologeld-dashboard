...
const Notifications = () => {
  ...
  return (
    <div>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              className="data-[state=checked]:bg-[#0D9488] data-[state=unchecked]:bg-gray-200"
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Label
                htmlFor="comments"
                className="text-sm font-medium text-[#3         0373D]"
              >
                Comments
              </Label>
              <Tooltip>
      ...
      <Button
        onClick={handleSave}
        className="bg-[#0D9488] hover:bg-[#25a399] text-white px-8 mt-6"
      >
        Save
      </Button>
    </div>
